...
import 'schema/medication_1_record.dart';
...
export 'schema/medication_1_record.dart';
...
/// Functions to query Medication1Records (as a Stream and as a Future).
Future<int> queryMedication1RecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      Medication1Record.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<Medication1Record>> queryMedication1Record({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<Medication1Record>> queryMedication1RecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<Medication1Record>> queryMedication1RecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
