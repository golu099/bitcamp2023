...
class AppStateNotifier extends ChangeNotifier {
  Bitcamp2023FirebaseUser? initialUser;
  Bitcamp2023FirebaseUser? user;
  ...
  void update(Bitcamp2023FirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/patientPortal',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'patientPortal')
              : PatientPortalWidget(),
        ),
        FFRoute(
